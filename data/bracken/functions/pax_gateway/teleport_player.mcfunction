...
execute if entity @s[scores={bp.portal_R=1,bp.portal_G=1,bp.portal_B=1,bp.portal_W=0},tag=bp.underdark_key] as @p[tag=bp.portal_teleport] run function bracken:dimension_crossing/overworld_to_underdark
...
execute if entity @s[scores={bp.portal_R=1,bp.portal_G=1,bp.portal_B=0,bp.portal_W=0},tag=bp.overworld_key] as @p[tag=bp.portal_teleport] run function bracken:dimension_crossing/faewild_to_overworld
