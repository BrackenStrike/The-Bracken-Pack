...
execute as @s if score @s bp.xchunk = @e[type=marker,tag=bp.recall,sort=nearest,limit=1] bp.xchunk if score @s bp.zchunk = @e[type=marker,tag=bp.recall,sort=nearest,limit=1] bp.zchunk run tag @s add bp.chunk_marker
