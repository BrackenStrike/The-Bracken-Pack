...
execute if entity @e[distance=..5,tag=!bp.outlander] positioned ^ ^1 ^ run function bracken:player/species/outlander/raycast_tag
...
execute unless entity @e[tag=bp.outlander_backstab,distance=..5] run attribute @s generic.attack_damage modifier remove 31e28d67-5bbe-425b-a9bb-64ae4132b609
