...
execute at @s run spreadplayers ~ ~ 0 256 under 128 false @s[predicate=bracken:the_nether]
execute at @s run spreadplayers ~ ~ 0 256 under 220 false @s[predicate=bracken:the_underdark]
