...
execute if entity @s[scores={bp.tick=2}] if entity @e[type=minecraft:eye_of_ender,distance=0.5..,nbt={Item:{tag:{bracken:{id:"enderling_controlled_teleport"}}}}] run function bracken:player/species/enderling/controlled_teleport