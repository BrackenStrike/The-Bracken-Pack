...
data merge entity @e[type=fox,distance=..100,limit=1,sort=nearest,tag=!bp.trilobite] {ActiveEffects:[{Id:14,Amplifier:1b,Duration:40000000,ShowParticles:0b}],Tags:[bp.trilobite],Silent:1b,DeathLootTable:"bracken:entity/the_brine/trilobite",CanPickUpLoot:0b,HandItems:[{id:"minecraft:bamboo",Count:1b,tag:{CustomModelData:888502}},{}],HandDropChances:[0.000F,0.000F],Attributes:[{Name:generic.max_health,Base:10},{Name:generic.movement_speed,Base:0.2}]}
