...
execute at @e[type=zombie_villager,distance=..100,limit=1,sort=nearest] run summon ravager ~ ~ ~ {CustomName:'{"text":"Yakitubba","color":"dark_green"}',CustomNameVisible:0b,Silent:1,Attributes:[{Name:generic.follow_range,Base:64},{Name:generic.movement_speed,Base:0.0}],ActiveEffects:[{Id:14,Amplifier:1b,Duration:-1,ShowParticles:0b},{Id:1,Amplifier:1b,Duration:5b,ShowParticles:0b}],Tags:["bp.yakitubba2","bp.entity","bp.rain_event"],DeathLootTable:"bracken:entity/yakitubba2",DisabledSlots:4144959,Passengers:[{id:"minecraft:armor_stand",Small:0b,Invisible:1b,ArmorItems:[{},{},{},{id:"minecraft:bamboo",Count:1b,tag:{CustomModelData:888508}}],ArmorDropChances:[0.085F,0.085F,0.085F,0.000F],Tags:["bp.rain_event_marker"]}]}
