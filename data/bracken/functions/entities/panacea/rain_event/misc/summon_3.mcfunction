...
scoreboard players operation #1 bp.math.out %= #summon bp.rain_event

execute if score #1 bp.math.out matches 0 run function bracken:entities/panacea/rain_event/mob/ventithrub/summon
