...
summon giant ~0.5 ~0.5 ~0.5 {CustomName:'{"text":"Dinnerbone","color":"green","obfuscated":true}',Silent:1b,DeathLootTable:"bracken:entity/boss/project_ruination",Health:400f,PersistenceRequired:1b,NoAI:1b,HandItems:[{id:"minecraft:ender_eye",Count:1b,tag:{CustomModelData:888503}},{id:"minecraft:ender_eye",Count:1b,tag:{CustomModelData:888503}}],HandDropChances:[0.000F,0.000F],Tags:["bp.project_ruination.core"],Attributes:[{Name:generic.max_health,Base:400}],ActiveEffects:[{Id:14b,Amplifier:1b,Duration:2000000,ShowParticles:0b}]}
