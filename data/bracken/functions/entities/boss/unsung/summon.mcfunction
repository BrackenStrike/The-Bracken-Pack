...
summon minecraft:zombie ~ ~1 ~ {Johnny:1b,NoAI:1b,Invulnerable:1b,DeathLootTable:"bracken:entity/unsung",Health:400,Tags:["bp.boss","bp.unsung"],IsImmuneToZombification:1,PersistenceRequired:1b,Glowing:0,Attributes:[{Name:"generic.follow_range",Base:80},{Name:"generic.knockback_resistance",Base:0.1f},{Name:"generic.movement_speed",Base:0.4f},{Name:generic.max_health,Base:400},{Name:"generic.attack_damage",Base:20}],Silent:1,HandItems:[{id:"minecraft:netherite_sword",Count:1b,tag:{display:{Name:'{"text":"Paxmaker Sword","color":"white"}',Lore:['{"text":"A protector, usque in diem, cum omnes gladiis sunt comminutae.","color":"white"}']},HideFlags:2,CustomModelData:888501,Enchantments:[{id:"minecraft:smite",lvl:7s},{id:"minecraft:knockback",lvl:7s},{id:"minecraft:sweeping",lvl:7s}],AttributeModifiers:[{AttributeName:"generic.movement_speed",Name:"generic.movement_speed",Amount:0.01,Operation:0,UUID:[I;-634720404,-2008137301,-1464112300,-1011647009],Slot:"mainhand"}]}},{}],HandDropChances:[0.000F,0.085F],ActiveEffects:[{Id:12,Amplifier:0,Duration:2147483647,ShowParticles:0b},{Id:8,Amplifier:2,Duration:2147483647,ShowParticles:0b},{Id:14,Amplifier:0,Duration:2147483647,ShowParticles:0b}]}
