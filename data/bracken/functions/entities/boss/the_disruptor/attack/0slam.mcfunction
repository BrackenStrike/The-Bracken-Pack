...
execute if entity @s[tag=bp.slam] unless block ~ ~-0.5 ~ air run scoreboard players set attack.state bp.the_disruptor 69
execute if entity @s[tag=bp.slam] unless block ~ ~-0.5 ~ air run scoreboard players set attack.cd bp.the_disruptor 60
