...
tellraw @a[distance=..150,scores={bp.longtick=..100}] {"text":"The Thrall speaks: \"Are you afraid?\"","color":"gold","bold":true}

tellraw @a[distance=..150,scores={bp.longtick=101..}] {"text":"The Thrall speaks: \"And then?\"","color":"gold","bold":true}
