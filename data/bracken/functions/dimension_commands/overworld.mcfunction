...
execute if score #bp.dimension_travel_dummy bp.dimension_travel_con matches 1 if score @s bp.tick matches 1 if entity @e[distance=..3,type=minecraft:item_display,tag=bp.brine_entrance] run function bracken:dimension_crossing/spawn_platforms/find_brine
