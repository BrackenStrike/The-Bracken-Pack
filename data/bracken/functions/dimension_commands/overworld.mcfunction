...
execute if score @s bp.1_second matches 4 if score #bp.dimension_travel_dummy bp.dimension_travel_con matches 1 if entity @e[distance=..26,type=minecraft:item_display,tag=bp.brine_entrance] run function bracken:dimension_commands/other/brine_entrance_portal
