...
execute at @e[type=armor_stand,tag=bp_dimension_armor_stand] unless block ~ ~-1 ~ minecraft:redstone_block unless entity @p[distance=..30] run kill @e[type=armor_stand,tag=bp_dimension_armor_stand,distance=..1]
