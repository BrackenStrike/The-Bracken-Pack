...
#execute if score @s bp.brine_potion matches 104 run data modify block ~ ~ ~ Items[{Slot:2b}] merge value {tag:{bp:[{id:"potion_modified1"}],CustomPotionEffects:[{Duration:200,Id:0,Amplifier:0}]}}
...
execute if score @s bp.brine_potion matches 108 run data modify block ~ ~ ~ Items[{Slot:2b}] merge value {tag:{bp:[{id:"potion_modified1"},{id:"check"}],CustomPotionEffects:[{Id:2,Duration:60,Amplifier:2},{Id:9,Duration:100},{Id:15,Duration:100},{Id:19,Duration:300,Amplifier:1},{Id:20,Duration:150,Amplifier:1}]}}
