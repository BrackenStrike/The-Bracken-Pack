...
execute if score @s bp.brine_potion matches 101 run data modify block ~ ~ ~ Items[{Slot:1b}] merge value {tag:{bp:[{id:"potion_modified1"},{id:"check"}],CustomPotionEffects:[{Duration:9600,Id:30},{Duration:9600,Id:29}]}}
#execute if score @s bp.brine_potion matches 102 run data modify block ~ ~ ~ Items[{Slot:1b}] merge value {tag:{bp:[{id:"potion_modified1"},{id:"check"}],CustomPotionEffects:[{Duration:200,Id:0,Amplifier:0}]}}
execute if score @s bp.brine_potion matches 103 run data modify block ~ ~ ~ Items[{Slot:1b}] merge value {tag:{bp:[{id:"potion_modified1"},{id:"check"}],CustomPotionEffects:[{Duration:600,Id:15}]}}
#execute if score @s bp.brine_potion matches 104 run data modify block ~ ~ ~ Items[{Slot:1b}] merge value {tag:{bp:[{id:"potion_modified1"},{id:"check"}],CustomPotionEffects:[{Duration:200,Id:0,Amplifier:0}]}}
...
execute if score @s bp.brine_potion matches 107 run data modify block ~ ~ ~ Items[{Slot:1b}] merge value {tag:{bp:[{id:"potion_modified1"},{id:"check"}],CustomPotionEffects:[{Duration:600,Id:9}]}}
