...
scoreboard players remove @s[predicate=bracken:sprint0,scores={sprintcharge=1..}] sprintcharge 1
scoreboard players add @s[predicate=bracken:sprint] sprintcharge 4
scoreboard players set @s[scores={sprintcharge=101..}] sprintcharge 100
...
effect give @s[scores={longtick=7},predicate=bracken:sprint0] minecraft:saturation 1 0 true
