...
execute if entity @s[scores={bp.overworld=2..}] run fill ~3 11 ~3 ~-3 11 ~-3 minecraft:oak_leaves replace minecraft:air
execute if entity @s[scores={bp.pax=2..}] run fill ~3 245 ~3 ~-3 245 ~-3 minecraft:oak_leaves replace minecraft:air
