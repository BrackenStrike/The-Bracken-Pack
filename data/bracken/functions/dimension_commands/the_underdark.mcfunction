...
execute at @s run execute as @a[y=252,dy=100,predicate=bracken:the_underdark] run function bracken:dimensions/underdark_to_overworld
execute at @s run execute as @a[y=5,dy=-100,predicate=bracken:the_underdark] run function bracken:dimensions/underdark_to_nether