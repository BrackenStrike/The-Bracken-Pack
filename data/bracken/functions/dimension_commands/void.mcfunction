...
execute as @s[tag=bp.to_mansion] run function bracken:ability_books/mansion/tp_to_mansion/tp_to_mansion_setup
execute as @s[tag=bp.mansion] run function bracken:ability_books/mansion/create_mansion/tp_to_mansion_setup
