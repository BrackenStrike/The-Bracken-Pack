...
execute if score #bp.dimension_travel_dummy bp.dimension_travel_con matches 1 if score @s bp.tick matches 1 if entity @e[distance=..16,type=minecraft:item_display,tag=bp.brine_portal_exit] run effect give @s levitation 1 10 false
