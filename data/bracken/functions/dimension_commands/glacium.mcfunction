...
execute unless entity @s[predicate=bracken:lesslightlevel] run execute at @s positioned over ocean_floor if entity @s[predicate=bracken:rain,dy=999] run effect give @s[team=!Frostkin] minecraft:wither 1 1 false