...
tp @p[tag=bp.mansion_2,predicate=bracken:void] @s
execute as @p[tag=bp.mansion_2,predicate=bracken:void] at @s run function bracken:ability_books/mansion/create_mansion/place_mansion
