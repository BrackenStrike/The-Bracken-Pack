...
execute unless entity @s[scores={bp.mansion_use=2..}] if entity @s[level=..1,tag=bp.set_mansion] run tellraw @s "You do not have enough levels to cast this spell."
execute unless entity @s[scores={bp.mansion_use=2..}] if entity @s[level=..19,tag=!bp.set_mansion] run tellraw @s "You do not have enough levels to cast this spell."
