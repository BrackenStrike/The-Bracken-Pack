...
#execute if entity @s[predicate=bracken:dimensions/dormis] run scoreboard players set @s bp.dimension 9
...
execute if entity @s[predicate=bracken:dimensions/pax] run scoreboard players set @s bp.dimension -3
execute if entity @s[predicate=bracken:dimensions/the_faewild] run scoreboard players set @s bp.dimension -4
execute if entity @s[predicate=bracken:dimensions/the_underdark] run scoreboard players set @s bp.dimension -5
...
execute if entity @s[scores={bp.dimension=0}] run tellraw @s "§cThis dimension is incompatible to use Magnificent Mansion."
