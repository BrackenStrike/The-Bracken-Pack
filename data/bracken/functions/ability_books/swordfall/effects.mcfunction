...
execute at @e[type=minecraft:giant,tag=bp.sword] positioned ^1.5 ^1.8 ^5 if entity @e[type=!minecraft:item,distance=..2] run function bracken:ability_books/swordfall/damage
