...
loot replace entity @s[scores={bp.offhand=0}] weapon loot bracken:item/worm_toothed_burrower
item replace entity @s[scores={bp.offhand=1}] weapon.offhand with air
loot replace entity @s[scores={bp.offhand=1}] weapon.offhand loot bracken:item/worm_toothed_burrower
...
execute if entity @s[level=12..] run schedule function bracken:ability_books/worm-toothed_burrower_folder/worm-toothed_burrower 1t
...
execute at @e[type=minecraft:giant,name=Dinnerbone,tag=tooth] run schedule function bracken:ability_books/worm_toothed_burrower 1t
