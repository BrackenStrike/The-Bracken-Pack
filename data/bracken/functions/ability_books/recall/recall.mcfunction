...
execute if entity @s[scores={bp.recall_use=1},level=..0] unless block ~ ~ ~ minecraft:enchanting_table run tellraw @s "You do not have enough levels to cast this spell."
