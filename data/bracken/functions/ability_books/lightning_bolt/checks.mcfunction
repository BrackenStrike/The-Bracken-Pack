...
execute if score #bp.ability_books_dummy bp.books_con matches 1 if score @s bp.cooldown matches 0 if entity @s[level=25..] run function bracken:ability_books/lightning_bolt/lightning_bolt
