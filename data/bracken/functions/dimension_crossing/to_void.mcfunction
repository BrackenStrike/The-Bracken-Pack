...
advancement revoke @s only bracken:technical/dimension_crossing/sanctum_to_void
advancement revoke @s only bracken:technical/dimension_crossing/glacium_to_void
advancement revoke @s only bracken:technical/dimension_crossing/brine_to_void
