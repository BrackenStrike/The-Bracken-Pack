...
tag @e[type=marker,tag=bp.brine_use,sort=nearest,limit=1] add bp.brine_death
execute in bracken:the_brine run forceload add ~ ~
execute in bracken:the_brine run kill @e[type=marker,tag=bp.brine_death,distance=..10]
