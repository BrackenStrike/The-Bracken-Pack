...
scoreboard players set @s[scores={sprint=1..}t] activity 1
scoreboard players set @s[scores={hurting=2..}] activity 1

effect give @s[scores={activity=197..}] minecraft:invisibility 1 0 true
effect give @s[scores={activity=197..}] minecraft:wither 1 0 true
