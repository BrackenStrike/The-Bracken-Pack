...
execute unless entity @s[level=5..] run loot replace entity @s weapon loot bracken:item/great_nullifier
...
execute if entity @s[level=5..] run say @s used [GREAT NULLIFIER]
