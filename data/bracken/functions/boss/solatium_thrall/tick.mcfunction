bossbar set bp:solatium_thrall players @a[distance=..100]
execute store result bossbar bp:solatium_thrall value run data get entity @s Health 1
...
execute at @e[type=area_effect_cloud,name=Solatium_Field] run tellraw @a[scores={longtick=5},distance=..10] {"text":"Thrall: Fall with your arrogance!\"","color":"gold","bold":true}
