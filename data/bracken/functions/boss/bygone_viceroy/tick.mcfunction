...
execute unless entity @e[type=minecraft:wither_skeleton,tag=bp.bygone_viceroy,distance=0.1..3] run effect give @s[tag=active] minecraft:instant_health 1 1 true
