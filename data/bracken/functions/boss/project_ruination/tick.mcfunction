...
execute if entity @s[tag=bp.project_ruination.started] unless entity @e[type=minecraft:giant,tag=bp.project_ruination.core,distance=..1,limit=1] run summon experience_orb ~1 ~ ~ {NoGravity:1b,Glowing:1b,Value:100}
execute if entity @s[tag=bp.project_ruination.started] unless entity @e[type=minecraft:giant,tag=bp.project_ruination.core,distance=..1,limit=1] run summon experience_orb ~-1 ~ ~ {NoGravity:1b,Glowing:1b,Value:100}
execute if entity @s[tag=bp.project_ruination.started] unless entity @e[type=minecraft:giant,tag=bp.project_ruination.core,distance=..1,limit=1] run summon experience_orb ~ ~ ~1 {NoGravity:1b,Glowing:1b,Value:100}
execute if entity @s[tag=bp.project_ruination.started] unless entity @e[type=minecraft:giant,tag=bp.project_ruination.core,distance=..1,limit=1] run summon experience_orb ~ ~ ~-1 {NoGravity:1b,Glowing:1b,Value:100}
