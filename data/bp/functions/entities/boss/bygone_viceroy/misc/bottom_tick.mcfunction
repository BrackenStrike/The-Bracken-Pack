...
execute if score @s bp.bygn_vcroy.t matches ..0 if score #1 bp.math.out matches 0 run function bp:entities/boss/bygone_viceroy/attacks/speed
execute if score @s bp.bygn_vcroy.t matches ..0 if score #1 bp.math.out matches 1 run function bp:entities/boss/bygone_viceroy/attacks/summon
