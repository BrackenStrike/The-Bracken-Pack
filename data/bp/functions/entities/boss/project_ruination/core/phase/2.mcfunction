...
execute if score @s bp.prjct_ruin.cd matches ..0 if score @s bp.prjct_ruin.a matches 0 if score data bp.prjct_ruin matches 0 run function bp:entities/boss/project_ruination/core/attack/varsk_bomb
execute if score @s bp.prjct_ruin.cd matches ..0 if score @s bp.prjct_ruin.a matches 1 run function bp:entities/boss/project_ruination/core/attack/shockwave
execute if score @s bp.prjct_ruin.cd matches ..0 if score @s bp.prjct_ruin.a matches 2 run function bp:entities/boss/project_ruination/core/attack/explode

execute unless score @s bp.prjct_ruin.cd matches ..0 if score @s bp.prjct_ruin.a matches 0 run function bp:entities/boss/project_ruination/core/attack/varsk_bomb
execute unless score @s bp.prjct_ruin.cd matches ..0 if score @s bp.prjct_ruin.a matches 1 run function bp:entities/boss/project_ruination/core/attack/shockwave
execute unless score @s bp.prjct_ruin.cd matches ..0 if score @s bp.prjct_ruin.a matches 2 run function bp:entities/boss/project_ruination/core/attack/explode
