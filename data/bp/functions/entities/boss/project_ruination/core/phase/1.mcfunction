...
execute if score @s bp.prjct_ruin.cd matches ..0 run function bp:math/random
...
execute if score @s bp.prjct_ruin.cd matches ..0 if score @s bp.prjct_ruin.a matches 0 if score data bp.prjct_ruin matches 0 run function bp:entities/boss/project_ruination/core/attack/steal
execute if score @s bp.prjct_ruin.cd matches ..0 if score @s bp.prjct_ruin.a matches 1 run function bp:entities/boss/project_ruination/core/attack/construct
execute if score @s bp.prjct_ruin.cd matches ..0 if score @s bp.prjct_ruin.a matches 2 run function bp:entities/boss/project_ruination/core/attack/fangs

execute unless score @s bp.prjct_ruin.cd matches ..0 if score @s bp.prjct_ruin.a matches 0 run function bp:entities/boss/project_ruination/core/attack/steal
execute unless score @s bp.prjct_ruin.cd matches ..0 if score @s bp.prjct_ruin.a matches 1 run function bp:entities/boss/project_ruination/core/attack/construct
execute unless score @s bp.prjct_ruin.cd matches ..0 if score @s bp.prjct_ruin.a matches 2 run function bp:entities/boss/project_ruination/core/attack/fangs
