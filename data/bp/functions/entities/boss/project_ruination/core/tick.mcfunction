...
execute if score @s bp.prjct_ruin.p matches 1 run function bp:entities/boss/project_ruination/core/phase/1
execute if score @s bp.prjct_ruin.p matches 2 run function bp:entities/boss/project_ruination/core/phase/2
execute if score @s bp.prjct_ruin.p matches 3 run function bp:entities/boss/project_ruination/core/phase/3
...
execute if entity @s[scores={bp.doomsday=999}] run loot give @a[distance=..50] loot bp:item/lightning_bolt 
