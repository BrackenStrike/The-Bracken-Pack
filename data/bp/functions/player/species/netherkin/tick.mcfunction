...
execute unless predicate bp:in_boat if block ~ ~ ~ minecraft:water run effect give @s minecraft:wither 1 1 false
...
execute unless predicate bp:the_nether run attribute @s minecraft:generic.attack_damage modifier remove fe166266-e90d-4172-b0ca-0c7ab99cfaed
execute if predicate bp:the_nether run attribute @s minecraft:generic.attack_damage modifier add fe166266-e90d-4172-b0ca-0c7ab99cfaed "bp.netherkin.attack_damage" 0.15 multiply
