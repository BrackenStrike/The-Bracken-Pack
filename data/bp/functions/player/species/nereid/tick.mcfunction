...
execute unless predicate bp:in_boat if block ~ ~ ~ minecraft:water run attribute @s minecraft:generic.movement_speed modifier remove 635aac34-da46-4906-b1d7-f7bb7ecb89b4
execute unless predicate bp:in_boat if block ~ ~ ~ minecraft:water run effect give @s minecraft:haste 1 2 true
