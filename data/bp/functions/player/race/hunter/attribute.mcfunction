...
execute if score @s bp.food matches 20 run attribute @s minecraft:generic.movement_speed modifier add 4fd539a4-8f7d-0000-5000-d07da532a501 "bp.hunter_speed_full" 0.02 add
