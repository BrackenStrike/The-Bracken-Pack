...
execute if entity @s[scores={bp.hmorph=0}] run function bp:player/race/hunter/attribute
...
execute if score @s bp.food matches ..3 run function bp:player/race/hunter/demorph
execute as @s[scores={bp.health=0}] run function bp:player/race/hunter/demorph
