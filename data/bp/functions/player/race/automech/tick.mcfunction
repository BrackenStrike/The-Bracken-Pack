...
execute if entity @s[scores={bp.longtick=2}] run function bp:player/race/automech/attribute

effect give @s[scores={bp.longtick=2},predicate=bp:omnidrome] minecraft:saturation 13 1 true
