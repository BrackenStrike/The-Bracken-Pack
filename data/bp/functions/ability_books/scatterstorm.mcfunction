...
loot replace entity @s[scores={bp.offhand=0}] weapon loot bp:item/scatterstorm
item replace entity @s[scores={bp.offhand=1}] weapon.offhand with air
loot replace entity @s[scores={bp.offhand=1}] weapon.offhand loot bp:item/scatterstorm
...
execute if entity @s[level=3..] run spreadplayers ~ ~ 20 30 under 120 false @s[predicate=bp:the_nether,distance=..20]
execute if entity @s[level=3..] run spreadplayers ~ ~ 20 30 under 250 false @s[predicate=bp:the_underdark,distance=..20]
