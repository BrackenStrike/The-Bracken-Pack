...
loot replace entity @s[scores={bp.offhand=0}] weapon loot bp:item/adamantine_will
item replace entity @s[scores={bp.offhand=1}] weapon.offhand with air
loot replace entity @s[scores={bp.offhand=1}] weapon.offhand loot bp:item/adamantine_will

execute if entity @s[level=7..] run playsound bp:ability_book_tier_4 player @a ~ ~ ~ 10 
