...
loot replace entity @s[scores={bp.offhand=1}] weapon.offhand loot bp:item/fireball
item replace entity @s[scores={bp.offhand=0}] weapon with air
loot replace entity @s[scores={bp.offhand=0}] weapon loot bp:item/fireball

execute if entity @s[level=2..] run playsound bp:ability_book_tier_1 player @a ~ ~ ~ 10
