...
loot replace entity @s[scores={bp.offhand=0}] weapon loot bp:item/frostlock
item replace entity @s[scores={bp.offhand=1}] weapon.offhand with air
loot replace entity @s[scores={bp.offhand=1}] weapon.offhand loot bp:item/frostlock
...
execute at @e[type=minecraft:area_effect_cloud,name="frostlock"] run schedule function bp:spell_books/frostlock 5t
