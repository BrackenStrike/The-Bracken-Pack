...
loot replace entity @s[scores={bp.offhand=0}] weapon loot bp:item/truelight_glow
item replace entity @s[scores={bp.offhand=1}] weapon.offhand with air
loot replace entity @s[scores={bp.offhand=1}] weapon.offhand loot bp:item/truelight_glow
