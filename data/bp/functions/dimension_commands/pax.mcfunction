...
execute in bp:pax run kill @e[type=arrow,distance=..100]

# migrated to advancements
#execute if entity @s[y=-15,dy=-100] run function bp:dimension_crossing/pax_to_faewild
#execute if entity @s[y=1550,dy=100] run function bp:dimension_crossing/pax_to_dormis
