...
scoreboard players remove @s[predicate=!bp:sprint,scores={bp.sprintcharge=1..}] bp.sprintcharge 1
scoreboard players add @s[predicate=bp:sprint] bp.sprintcharge 2
...
execute at @s[scores={bp.sprintcharge=60..}] run summon minecraft:lightning_bolt ^ ^ ^-7
...
effect give @s[scores={bp.longtick=7},predicate=!bp:sprint] minecraft:saturation 1 0 true



execute at @s[scores={bp.ice=400..}] run function bp:dimension_crossing/overworld_to_glacium
