...
#execute if entity @s[y=243,dy=100] run function bp:dimension_crossing/underdark_to_overworld
#execute if entity @s[y=5,dy=-100] run function bp:dimension_crossing/underdark_to_nether

##########   POLYFOLUS   ##########
execute as @e[type=minecraft:item,nbt={Item:{id:"minecraft:red_mushroom_block",tag:{CustomModelData:888501}}}] at @s run function bp:entities/the_underdark/polyfolus
