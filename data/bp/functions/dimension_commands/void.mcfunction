...
effect give @s[gamemode=!creative,team=!Watcher,scores={bp.longtick=8}] minecraft:blindness 29 9 true

# migrated to advancements
#execute if entity @s[y=252,dy=100] run function bp:dimension_crossing/void_to_sanctum
