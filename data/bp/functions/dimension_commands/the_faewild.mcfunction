...
effect give @s[predicate=bp:sneak] minecraft:slow_falling 1 0 true
effect clear @s[predicate=!bp:sneak] minecraft:slow_falling
...
#execute if entity @s[y=250,dy=100] run function bp:dimension_crossing/faewild_to_pax
#execute if entity @s[y=-15,dy=-100] run function bp:dimension_crossing/faewild_to_overworld